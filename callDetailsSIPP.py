...
if __name__ == '__main__':
    ...
    if ssh_handle_client and ssh_handle_server:
        commandListClient = ['cd tc && /ats/bin/sipp -i 10.54.81.66 -p 5070 -sf Register_UAC.xml -inf register.csv phone.plivo.com:5060 -m 1 -trace_msg -message_file /home/vkonreddi/tc/register_uac.log ']
        commandListServer=['cd tc && /ats/bin/sipp -i 10.54.81.67 -p 5070 -sf Register_UAC.xml -inf register1.csv phone.plivo.com:5060 -m 1 -trace_msg -message_file /home/vkonreddi/tc/register_uas.log']
    ...
    ssh_handle_server = PrintCallDetailsSIPPObj.loginSession('10.54.81.66', 'vkonreddi', 'Jun_2019', 22, '', 2)
    if ssh_handle_client and ssh_handle_server:
        commandListClient = ['cd tc && /ats/bin/sipp -sf /home/vkonreddi/tc/uac.xml -i 10.54.81.66 -p 5070  -inf /home/vkonreddi/tc/call.csv phone.plivo.com:5060 -m 1  -trace_msg -message_file /home/vkonreddi/tc/uac_messages.log ']
        commandListServer=['cd tc && /ats/bin/sipp -sf /home/vkonreddi/tc/uas.xml -i 10.54.81.67 -p 5070  -inf /home/vkonreddi/tc/call.csv phone.plivo.com:5060 -m 1  -screen_file /home/vkonreddi/tc/uas_screen_file -trace_screen -trace_msg -message_file /home/vkonreddi/tc/uas_messages.log']
        t1=threading.Thread(target=PrintCallDetailsSIPPObj.executeCLIShell, args=(ssh_handle_server,commandListServer, "server.log"))        
        t2=threading.Thread(target=PrintCallDetailsSIPPObj.executeCLIShell, args=(ssh_handle_client,commandListClient, "client.log"))
        t1.start()
        t2.start()
